...
//var kullanicilar = await context.Kullanicilar.AsNoTracking().ToListAsync(); //hiçbir güncelleme işlemi yok yalnızca isimler yazdırılıyor. bu sebple takibe gerek yok.
...
//AsNoTrackingWithIdentityResolution : constructor örneğinde her yazar ve kitp için ayrı ayrı constrructor olması engellendi. genelde ilişkisel verir arasında kullanılır.
#endregion
...
public class ETicaretContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        optionsBuilder.UseQueryTrackingBehavior(QueryTrackingBehavior.NoTracking);  // var ise gelen datalar artık deault olrak takip eilmez.
    }
}
...
public class Kitap
{
    public Kitap() => Console.WriteLine("Kitap nesnesi oluşturuldu."); //constructor oluturuldu
    public int Id { get; set; }
