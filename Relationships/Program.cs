...
class Calisan
{
    ...
    public Departman Departman { get; set; } //demek ki calışan bir departman da.
}
class Departman
{
    public int Id { get; set; }
    ...
    public List<Calisan> Calisanlar { get; set; } //departmanlarda list e olarak calışan yani çoklu tutuyor. br depatmnda bir denfaa çalışan var anlamına gelir.
}
...
//public Calisan Calisanlar -- şeklinde yazardı.
#endregion
