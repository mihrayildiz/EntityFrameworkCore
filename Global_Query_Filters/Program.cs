...
//await context.Persons.FirstOrDefaultAsync(p => p.Name.Contains("a") || p.PersonId == 3); //hem a arfi barındıran hemde ktif olanaları getirir
#endregion
...
//global olan şart gözardı edilir.
#endregion
...
class ApplicationDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Person>().HasQueryFilter(p => p.IsActive); //bundan sonra person entity si için her orgulama yapıldığında aktif userları döner.
