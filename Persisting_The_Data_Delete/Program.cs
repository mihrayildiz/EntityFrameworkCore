...
//Urun urun = await context.Urunler.FirstOrDefaultAsync(u => u.Id == 5); //burada context üzerinde veiyi çağırdık.
//context.Urunler.Remove(urun); //dlayısıyla burda da tracker ile silmiş olduk.
...
//ETicaretContext context = new();
//Urun u = new()  //brada context üzerinden gelmiyor data 
//{
//    Id = 2
//};
