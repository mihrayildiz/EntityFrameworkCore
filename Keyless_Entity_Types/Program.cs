...
class ApplicationDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<PersonOrderCount>()
            .HasNoKey()
            .ToView("vw_PersonOrderCount"); //view olrak yolladım bu yüzden bunu vieew olarak algılar yani migrate ettiğinide
                                            //bir tablo olarak algılamayacağı için primary key olmamasına hata vermez.
    }
