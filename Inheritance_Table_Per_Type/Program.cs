...
//hiç employee eklenmediği halde yine de silinebilir.
//çünkü önceden eklenen veriler hiyerarchicaldan dolaı employee ya kayıt attı.techinacan olana
//eklerken employyeden türediği için employee de vr atılmıştı.yani 3 numaraı id ye employess stünden eriştik.
...
//await context.SaveChangesAsync();
//sadece employee ile kayıt atılanlar gelir.

//var technicians = await context.Technicians.ToListAsync();
//var employees = await context.Employees.ToListAsync(); //employeede olan herkes örneğin teknik adamlarıda gösterir çünk
//çünkü tekniklerde employyee ye girer.

//Console.WriteLine();

//yani alt class üst class özelliğini gösterir ancak üst class alt classın verilerini vermez.
#endregion
...
//migrate gerçekleştiğinde Employee ve Employee persondan gelen id yi alır Technician ise Employee den gelen.
//çünkü kalıtımsal olarak iç içeler.
//her bir enttiy içn bir tabe oluşturur ve ilgili prpertyii kolon olarak içerisnie koyar.

// ayrıca bstract classta olsa kalıtımsal sebiyle veri eklenebilir.