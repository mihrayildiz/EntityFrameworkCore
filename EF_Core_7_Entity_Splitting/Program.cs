...
class ApplicationDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entityBuilder.ToTable("Persons")  //Person entitysinin ana tablosu Persons tabloudur.
                .SplitToTable("PhoneNumbers", tableBuilder =>  //ayrımı belirtiyoruz.PhoneNumbers isimli ayrı tablo
                {
                    tableBuilder.Property(person => person.Id).HasColumnName("PersonId");  //ilişkiyi kurması için ıd kolonunu verdik.
