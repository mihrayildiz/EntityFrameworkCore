...
class ApplicationDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Person>().UseTpcMappingStrategy(); //TPC ile mapping işlem yaptığın bildirdik.entity framework 7 den onra geldi
        //TPT, TPH özellikleri de geldi.
    }
