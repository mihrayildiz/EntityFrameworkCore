...
//            .HasOne(a => a.Person)
//            .WithOne(p => p.Address)
//            .HasForeignKey<Address>(a => a.Id);  //!!! foreign key hangisi için tanımlandıysa o depndent entitydir.
//    }
//}
#endregion
...
#region 1. Yöntem -> Principal Entity Üzerinden Dependent Entity Verisi Ekleme
//Önce Principal Entity  Principal Entity nesnelerini türetip atdından dependent nesneleri ekliyoruz.
#region 1.1. Nesne Referansı Üzerinden Ekleme

//Blog blog = new() { Name = "Gencayyildiz.com Blog" }; //Blog türünde blog referansı oluşturdum.
//blog.Posts.Add(new() { Title = "Post 1" }); // referans nesnesi sayesinde Posts ekliyorum.
...
//await context.SaveChangesAsync();
#endregion
#region 1.2. Object Initializer Üzerinden Ekleme
//Blog blog2 = new()
//{
//    Name = "A Blog",
...
//    public Blog()
//    {
//        Posts = new HashSet<Post>();   //Nesne Referansı Üzerinden Ekleme de blog.Posts.Add(new() { Title = "Post 1" }); satırında Posts ile ekleme yapabilmek için 
//Posts un null olmaması gerekir o yüzden bu satır yazılır.
//    }
//    public int Id { get; set; }
//    public string Name { get; set; }
