...
public class GenderConverter : ValueConverter<Gender, string> //converter sınıfı tüetirken sonuna converter koyuyuoruz. ve bunu ValueConverter sınıfından türetiyoruz.
{
...
public class Person
{
    ...
    public Gender Gender2 { get; set; } //gender türüde gender2 
    public bool Married { get; set; }  //dbde bit olarak tutuluyor.
    public List<string>? Titles { get; set; }
}
public enum Gender  //enum olan gender 
{
    Male,
    Famele
}
public class ApplicationDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        //    .Property(p => p.Gender)
        //    .HasConversion(
        //        //INSERT - UPDATE  veritabanına yapılack işlem insert mi update mi bunun gibi
        //        g => g.ToUpper()
        //    ,
        //        //SELECT
        //        g => g == "M" ? "Male" : "Female"
        ...
        //   .HasConversion(
        //       //INSERT - UPDATE
        //       g => g.ToString()  //artık gelecek olan değer gender türünde bu yüden önce string olsun dedik.
        //       //g => (int)g//bu şekilde de olabilirdi.o zamanda dbde int olarak tutulurdu.
        //   ,
        //       //SELECT
        //       g => (Gender)Enum.Parse(typeof(Gender), g)
        //   );
        ...
        // .HasConversion<BoolToZeroOneConverter<int>>(); //bool oln ifadeyi int olarak tutmamızı sağlar.
        ...
        #endregion
        #region BoolToStringConverter
        //BoolToStringConverter converter = new("Bekar", "Evli");//veri false ise bekardır değilse evlidir.
