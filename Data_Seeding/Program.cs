...
class ApplicationDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Blog>() //hasdata ile sahip olacağı verileri yazdım .yeni verileri oluşturdum.
            .HasData(
                new Blog() { Id = 11, Url = "www.gencayyildiz.com/blog" }, //blog entiysne dataları yazdom ve primary key değerlerini de verim.
