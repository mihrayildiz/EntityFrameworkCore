...
//StoredPrıcedure eder bunun içinde dbden buraya fraeworke alınması içi bir entitty karşılığınını oolması gerekir.
//bU SEBEPLE dbset olarak tanımlama gerekir


//var datas = await context.PersonOrders.FromSql($"EXEC sp_PersonOrders") 
//    .ToListAsync();//PersonOrders entitysi üzerinden FromSql metodu ile sp_PersonOrders procedurenü execute ettik.
#endregion
#endregion
...
//{
//    ParameterName = "count",
//    SqlDbType = System.Data.SqlDbType.Int,  //dönecek olan değer it tipinde
//    Direction = System.Data.ParameterDirection.Output  //dönecek olan değer outputtur.
//};
//await context.Database.ExecuteSqlRawAsync($"EXEC @count = sp_bestSellingStaff", countParameter);
//geriye döndürülecek olan değer tipini yine @count =count olarak tuttuk.
...
//SqlParameter nameParameter = new()  //nameParameter
//{
...
//    Size = 1000
//};
//await context.Database.ExecuteSqlRawAsync($"EXECUTE sp_PersonOrders2 7, @name OUTPUT", nameParameter);  //isi 7 olan kişini adını verir.
...
[NotMapped] //PersonOrder bir tablo değil dedik db de bir tablo olarak karşılığı yok yani. 
...
class ApplicationDbContext : DbContext
{
    ...
    public DbSet<PersonOrder> PersonOrders { get; set; }  //bir enttiy tanımladık stored procedure tutmak çin
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.ApplyConfigurationsFromAssembly(Assembly.GetExecutingAssembly());

        modelBuilder.Entity<PersonOrder>() //her entity nin bir primary keyi olur ama storedprcedure için yaptığımız entityni olmıcak onu bildirdik.
            .HasNoKey();  
