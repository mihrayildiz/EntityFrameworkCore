...
//veriyi günceller ve verinin eski halini temporal table a atar.periodend değerinden de değiştiği değerin hangi tarihe kadar tutulduğu görülür.
#endregion
...
//silien veride temporal table a kayıt atılır.
#endregion
#endregion
...
await context.Database.ExecuteSqlInterpolatedAsync($"SET IDENTITY_INSERT dbo.Persons ON");  //ilgili özelliği açtık.
await context.SaveChangesAsync();
await context.Database.ExecuteSqlInterpolatedAsync($"SET IDENTITY_INSERT dbo.Persons OFF");  //ilgili özelliği kapattık.
...
class ApplicationDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        //employee entity için employees adında IsTemporal fonksiyonu ile geçici tablo olsun dedik.
