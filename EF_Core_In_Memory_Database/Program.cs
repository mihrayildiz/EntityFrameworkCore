...
//Öncelikle ilgili kütüphaneyi indiriyoruz.
...
class ApplicationDbContext : DbContext
{
    ...
    {
        optionsBuilder.UseInMemoryDatabase("exampleDatabase");  //exampleDatabase isminde bir in memory de çalışır db yoksa oluşturur varsa üzerinde işlemler
        //yapmaya devam eder. migrate gerekmez zaten inmemory üzerinde çalışıldığı için.
    }
}