...
//herhangi bi aksilik oldu ve db bağlantısı kesilirse yeniden bağlanamya çalşır ve 30 sn de bi 6 kez dener eğer oolmzsa hata verir.
...
class ApplicationDbContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        //    .LogTo( //sadece bağlantı koptğu zaman log dosasına yansıması için logu filtreledik.
        //    filter: (eventId, level) => eventId.Id == CoreEventId.ExecutionStrategyRetrying,
        //    logger: eventData =>
        //    {
        //        Console.WriteLine($"Bağlantı tekrar kurulmaktadır."); //kopma esnasında ekrana yazılsın.
        //    });
        #endregion
        #region Custom Execution Strategy
        ...
        //1o kere denesin max 15 snde
        #endregion
    }
}

class CustomExecutionStrategy : ExecutionStrategy //aşağıaki 3 class CustomExecutionStrategy içinden gelen classlardır.
{
