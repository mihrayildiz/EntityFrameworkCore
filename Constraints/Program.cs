...
//belirli kısıtlar koymamızı sağlar.
#region HasCheckConstraint

#endregion
#endregion

//[Index(nameof(Blog.Url), IsUnique = true)]  bir index verdik ve unque olsun dedik.url unique olsun dedik.
class Blog
{
...
class ApplicationDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        //    .HasName("ornek");
        //modelBuilder.Entity<Blog>()
        //    .HasAlternateKey(b => new { b.Url, b.BlogName }); //HasAlternateKey primary  key gibi kolona uniquelik verir.
        //ikisi aynı anda uiquelik verebilmeli.((a,b),(a,c)) gibi..
        //modelBuilder.Entity<Blog>()
        //    .Property<int>("BlogForeignKeyId"); //shadow property
        ...
        //modelBuilder.Entity<Blog>()
        //    .HasIndex(b => b.Url)   //url unique olsun demiş olduk.
        //    .IsUnique();
        //modelBuilder.Entity<Blog>()
        //    .HasAlternateKey(b => b.Url);

        modelBuilder.Entity<Post>()
            .HasCheckConstraint("a_b_check_const", "[A] > [B]"); //a_b_check_const istediğimiz bir isim.
    }
