...
//Console.WriteLine(employee.Region.Name);//employess içerisinde ki bir bilgiyi çağırdık ama diğer tablolar
//ilede bilgiler gelir çünkü employee ile işlem yaptığında databse ider sql oluşturur ve datayı alır buna lzty loading denir.
...
public class Employee
{
    ...
    public virtual List<Order> Orders { get; set; }// virtual ar yani kütüphanesi ile yaptık proxies  kullandık bu sebple
    //navigation başlarında zorunlu.
...
#endregion
#region ILazyLoader Interface'i İle Lazy Loading   :manuel birşekilde oluşturmak. proxies yok yani.
//public class Employee
//{
//    ILazyLoader _lazyLoader;  ///reference
//    Region _region;  //yine referance oluşturduk.
//    public Employee() { }//abstract 
//    public Employee(ILazyLoader lazyLoader)
//        => _lazyLoader = lazyLoader; //reference verdik.
//    public int Id { get; set; }
//    public int RegionId { get; set; }
//    public string? Name { get; set; }
//    public string? Surname { get; set; }
...
//    {
//        get => _lazyLoader.Load(this, ref _region); //tis : sınıfta, ref _region : referans
//        set => _region = value; //gelen değeri al 
//    }
//}
//public class Region
//{
...
//public class Employee
//{
//    Action<object, string> _lazyLoader; //Delegate tanımlandı.
//    Region _region;
//    public Employee() { }
...
//_lazyLoader da load fonksiyonu için bir extension yazılır.
//static class LazyLoadingExtension //extension fonksiyon yazılır Delegate kullanılması için.
//{
...
//        return navigation;
//    }
//}  this den sonra action, loder tanımlandı, entitiy bilgisi için parametre olrak object entity dedik,TRelated türünde
//ref verdik ve navigationname verildi.
#endregion
...
class ApplicationDbContext : DbContext
{
    ...
    {
        optionsBuilder
            .UseLazyLoadingProxies() //lazy loading metodu ile çalışacağımı belirtmeliyim.
