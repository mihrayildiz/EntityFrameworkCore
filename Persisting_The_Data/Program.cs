...
//ETicaretContext context = new();  //veri eklemek içi ilgili dbden bi context oluşturmak zorundayız.
//Urun urun = new()
//{
//    UrunAdi = "A Ürünü",
//    Fiyat = 1000
...
//await context.AddAsync(urun); //burada object olarak aır
#endregion
#region context.DbSet.AddAsync Fonksiyonu
//await context.Urunler.AddAsync(urun); //hangi türden bir veri atacamı bilyor yani urun atacağmı biliyor.
#endregion
