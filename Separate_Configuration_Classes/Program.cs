...
class OrderConfiguration : IEntityTypeConfiguration<Order>  //Order classı içi konfiür dosyası kullancağım demek.
{
...
class ApplicationDbContext : DbContext
{
    ...
    {
        //modelBuilder.ApplyConfiguration(new OrderConfiguration());   //OrderConfiguration bildirdim.     
        modelBuilder.ApplyConfigurationsFromAssembly(Assembly.GetExecutingAssembly()); //arkada Configurationlrı yakalar.
