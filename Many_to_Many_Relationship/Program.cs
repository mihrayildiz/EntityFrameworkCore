...
//}
////Cross Table  manuel oluşturmak zorundaydık ve oluşturduk.
//class KitapYazar
//{
//    [ForeignKey(nameof(Kitap))]
//    public int KId { get; set; }  //başka isimde bir foreign key vermek istedik. yani default değer ismi gelmesin dedik.[ForeignKey(nameof(Kitap))] kullandık. 
...
//public Kitap Kitap { get; set; }  //kitaplar classı ile bağladık.
//    public Yazar Yazar { get; set; }  //yazar classı ile bağladık.

//----------------aşağıda foreign key olarak verdik. zaten default olarak bu adı veriyorentity sonuna ıd koyunca otomatik
//olarka bir foreign key oldğnu kendisi anlıyor.
...
//---------------------------------------------------------------------
    ...
    {
        modelBuilder.Entity<KitapYazar>()
            .HasKey(ky => new { ky.KitapId, ky.YazarId }); //default bir tip oluşturup her iki kolonuda foreign key yapmış olduk.
