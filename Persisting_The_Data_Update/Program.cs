...
//Urun urun = await context.Urunler.FirstOrDefaultAsync(u => u.Id == 3); //FirstOrDefaultAsync buldğu ilk veriyi döndürür ve veri üzerinde update yapmızı sağlar
...
var urunler = await context.Urunler.ToListAsync(); //ToListAsync select sorgusu olarak verileri alı ve bir listeye atar.
