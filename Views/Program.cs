...
//var personOrders = await context.PersonOrders //viewı sorguladık
...
//var personOrder = await context.PersonOrders.FirstAsync();  //bu değişiklik olmaz yani yansımaz dbye
...
class ApplicationDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<PersonOrder>()
            .ToView("vm_PersonOrders") //viewın adı
            .HasNoKey();
