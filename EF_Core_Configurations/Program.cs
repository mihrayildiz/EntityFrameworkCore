...
//[Table("Kisiler")]  //table-totable konusu kapsamına girer. hangi sınıfın üstüne istersen ekleyebilisin.böylece b de artık Kisiler adnda tablo olur.
class Person
{
    //[Key]  //Id nin üzerine yazdım ve Id yi bir primary -key yaptım.
    public int Id { get; set; }
    //public int Id2 { get; set; }
    //[ForeignKey(nameof(Department))] //foreing key olarak verdm
    //public int DId { get; set; }
    //[Column("Adi", TypeName = "metin", Order = 7)]// public string Nameüzerine yazılırsa Column - HasColumnName, HasColumnType, HasColumnOrder

    public int DepartmentId { get; set; }
    public string _name;
    public string Name { get => _name; set => _name = value; }
    //[Required()] //Surname üzerine yazd ve zorunl alan dedi null olamaz yani
    //[MaxLength(13)]  //Surname max 13 karkter olabilir.
    //[StringLength(14)]
    [Unicode]
    ...
    //[NotMapped] //Laylaylom kolonu migrate te alınmadı yani eşleştirilmedi kolon olarak db ye gelmedi.
...
class Entity  
{
    public int Id { get; set; }   //primary key sadece esas classta verilir. A ve b classında verilmez.
    public string X { get; set; }
}
class A : Entity //Entity clasından türetilmiş bir class
{
    public int Y { get; set; }
}
class B : Entity //Entity clasından türetilmiş bir class
{
...
class ApplicationDbContext : DbContext
{
    ...
    {
        #region GetEntityTypes
        //var entities = modelBuilder.Model.GetEntityTypes(); //tüm entitlri getirdik.
        //foreach (var entity in entities)   //gelen entitleri ekrana yazdırdık.
        //{
        //    Console.WriteLine(entity.Name);
        //}
        #endregion
        #region ToTable
        //modelBuilder.Entity<Person>().ToTable("aksdmkasmdk"); //Person entity si db de adnı aksdmkasmdk verdik
        #endregion
        #region Column
        //modelBuilder.Entity<Person>()
        //    .Property(p => p.Name) //name property sini al
        //    .HasColumnName("Adi")  //Adi yap
        //    .HasColumnType("asldalsd")  //tipini ver
        //    .HasColumnOrder(7);  //7.kolon yap
        #endregion
        #region ForeignKey
        //modelBuilder.Entity<Person>()
        //    .HasOne(p => p.Department)
        //    .WithMany(d => d.Persons)
        //    .HasForeignKey(p => p.DId); /foreign key olarak verdim.
        #endregion
        #region Ignore
        //modelBuilder.Entity<Person>()  /Laylaylom kolonunu ignore et dedik.
        ...
        #region Property
        #region HasDefaultValue
        //modelBuilder.Entity<Person>()  //artk dn de slary ye default olrak atılan tüm değerler 100 dür.
        // .Property(p => p.Salary)
        // .HasDefaultValue(100);
        #endregion
        #region HasDefaultValueSql
        ...
        //    .HasDefaultValueSql("GETDATE()");  //dbde çalışabilece hazır bir fonkdiyon veriyoruz.
        #endregion
        #endregion 
        #region HasComputedColumnSql
        //modelBuilder.Entity<Example>()
        //    .Property(p => p.Computed) //Example ablosunda  Computed kolonuna git.
        //    .HasComputedColumnSql("[X] + [Y]");   //Example enittiysinde x ve y kolonunu topla Computed kolonuna değeri ver.
        #endregion
        #region HasConstraintName
        //modelBuilder.Entity<Person>()
        //    .HasOne(p => p.Department)
        ...
        //    .HasConstraintName("ahmet"); //Constraint te isim verdik.
        #endregion
        #region HasData
        //modelBuilder.Entity<Department>().HasData(   //DB de artık oluşturuldu bu dataları alır.
        //    new Department()
        //    {
        //        Name = "asd",
        //        Id = 1
        ...
        //    .HasDiscriminator<int>("Ayirici")  //Discriminator adının verid.
        //    .HasValue<A>(1)
        //    .HasValue<B>(2)
        //    .HasValue<Entity>(3);
        ...
        #endregion
        #region HasNoKey
        //modelBuilder.Entity<Example>()  //key vermiyorum.
        //    .HasNoKey();
        #endregion
        #region HasIndex
        //modelBuilder.Entity<Person>()
        ...
        #region HasQueryFilter
        //modelBuilder.Entity<Person>()
        //    .HasQueryFilter(p => p.CreatedDate.Year == DateTime.Now.Year);  //CreatedDate yalnızca bu yıl olsun gibi bir şart verdik.
        #endregion
    }
