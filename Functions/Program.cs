...
//                     where context.GetPersonTotalOrderPrice(person.PersonId) > 500 //funtiona erişmiş olduk.person lardan personId kolonunu yolladık.
...
public class BestSellingStaff  //inline functonu EFde karşılamak için class tanımladık.
{
    public string Name { get; set; }
...
class ApplicationDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        //new[] { typeof(int) } geriye döceği pmetre için tanımladı.
    ...
    public int GetPersonTotalOrderPrice(int personId) //dbden döncek olan sonucuda tutabilmek için EF DE FICTİONI TANIMLADIK.
        => throw new Exception();
    #endregion
    #region Inline Functions
    public IQueryable<BestSellingStaff> BestSellingStaff(int totalOrderPrice = 10000)  //int diyerek default olarak paremetre verdik.
