...
class ApplicationDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        //{
        //    builder.Property(e => e.Name).HasColumnName("Name");//buider ile de kolonlara eişebilirsin.
        //});
        //modelBuilder.Entity<Employee>().OwnsOne(e => e.Adress); //employee entitysi sahip adress entitysine
        #endregion
        #region OwnsMany
