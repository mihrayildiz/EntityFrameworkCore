...
//personId.DbType = System.Data.DbType.Int32;  //data tipini veriliyor.
...
#region Örnek 5
//SqlParameter personId = new("PersonId", "3");
//var persons = await context.Persons.FromSql($"EXECUTE dbo.sp_GetAllPersons @PersonId = {personId}")  //@dbdeki predure de parametre adı.
//    .ToListAsync();
#endregion
#endregion
#endregion
...
//string columnName = "PersonId";  //kolon ismini verdik.
