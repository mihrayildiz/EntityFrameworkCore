...
//{
//    var orders = await context.Orders.Where(o => o.EmployeeId == employee.Id).ToListAsync();//orderlarda ıd ile employee ıd aynı olan
//}
...
//...
//...
//await context.Entry(employee).Collection(e => e.Orders).LoadAsync();//oderlar employee içide colction olarak tutuluyr çünkü
