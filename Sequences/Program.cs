...
class ApplicationDbContext : DbContext
{
    ...
    {
        modelBuilder.HasSequence("EC_Sequence")   //bir sequence tanımladık adını verdik.
            .StartsAt(100)
            .IncrementsBy(5);
        ...
        modelBuilder.Entity<Employee>()
            .Property(e => e.Id)
            .HasDefaultValueSql("NEXT VALUE FOR EC_Sequence");  //sequence employee entitysinin ıd kolonuna verdik.

        modelBuilder.Entity<Customer>()
            .Property(c => c.Id)
            .HasDefaultValueSql("NEXT VALUE FOR EC_Sequence");  //aynı sequence si iki tabloya da verdik.
    }
